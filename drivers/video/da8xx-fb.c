...
#if 0
// for 1360*768				vsy=75hz hsy=61khz pclk=100m
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1360,
...
#if 0
// for 1360*768				vsy=56hz hsy=41khz pclk=75m
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1360,
...
#if 0
// for 1360*768				vsy=75hz hsy=61khz pclk=100m	1024*768*75
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1360,
...
#if 0
// for 1360*768				vsy=56hz hsy=46khz pclk=75m	1024*768*50
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1360,
...
#if 0
// for 1360*768				vsy=71hz hsy=65khz pclk=100m	1024*768*75
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1360,
...
#if 0
// for 1360*768				vsy=115hz hsy=85khz pclk=140m	no display
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1360,
...
#if 0
// for 1360*768				vsy=85hz hsy=67khz pclk=100m	no display
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1360,
...
#if 0
// for 1360*768				vsy=63hz hsy=50khz pclk=75m	1366*768*60
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1360,
...
#if 0
// for 1360*768				vsy=63hz hsy=50khz pclk=75m	1366*768*60 picture need move to right  +
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1360,
...
#if 0
// for 1360*768				vsy=63hz hsy=50khz pclk=75m	1366*768*60 picture need yasuo hfp
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1360,
...
#if 0
// for 1360*768				vsy=63hz hsy=50khz pclk=75m	1366*768*60 picture need compress hfp
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1360,
...
#if 0
// for 1360*768				vsy=63hz hsy=50khz pclk=75m	1366*768*60 picture full of screen
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1360,
...
#if 0
// for 1360*768				vsy=63hz hsy=50khz pclk=75m	1366*768*60 picture stretch
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1300,
...
#if 0
// for 1360*768				vsy=66hz hsy=53khz pclk=75m	1366*768*60 picture normal
	/* ThreeFive S9700RTWV35TR */
	[2] = {
		.name = "TFC_S9700RTWV35TR_01B",
		.width = 1360,
